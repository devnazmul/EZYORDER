...
- **Color Theme**: Placeholder shapes (texts, badges, circles, buttons) should use neutral, subtle slate tones (e.g., `bg-slate-200` for light mode, `bg-slate-800` for dark mode) matching the overall theme.
