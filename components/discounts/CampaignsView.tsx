...
import CampaignCard from "@/components/discounts/CampaignCard";
...
const CAMPAIGN_CATEGORIES = [
  {
    ...
    description: "Buy one get one free deals. Boost your sales volume with high-value item pairings.",
    color: "#DC2D2A",
  ...
  },
  {
    ...
    description: "Special bundle offers. Mix and match related products to increase basket size.",
    color: "#00677F",
  ...
  },
  {
    ...
    description: "Tiered spending rewards. Incentivize higher spending with progressive discounts.",
    color: "#D97706",
  ...
  },
  {
    ...
    description: "Store-wide savings. Run holiday sales or seasonal clearance across all categories.",
    color: "#8B5CF6",
  ...
  },
  {
    ...
    description: "Limited time flash sales. Create urgency with time-sensitive promotional windows.",
    color: "#F59E0B",
      ...
      <View className="gap-y-4">
        {CAMPAIGN_CATEGORIES.map((category) => (
          ...
          >
            ...
            <View className={`w-12 h-12 rounded-lg items-center justify-center ${category.bgColor} mr-4`}>
      ...
      ListEmptyComponent={
        isLoading ? (
          <View className="py-20 items-center justify-center">
            ...
            <Text className="mt-3 text-xs font-semibold text-accent">Loading campaign offers...</Text>
          </View>
        ) : (
          <EmptyState
            icon="event-note"
