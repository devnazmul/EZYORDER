...
export default function StatusBadge({
  ...
  let resolvedContainerClass = "flex-row items-center px-2.5 py-1 rounded-full border bg-neutral/5 border-neutral/10";
  ...
  if (s === "new" || s === "pending") {
    resolvedContainerClass = "flex-row items-center px-2.5 py-1 rounded-full border bg-blue-50 border-blue-100";
    resolvedTextClass = "text-[10px] font-bold text-blue-700";
    resolvedIconName = "fiber-new";
    resolvedIconColor = "#1D4ED8";
    resolvedLabel = label || "New";
  } else if (s === "kitchen" || s === "preparing") {
    resolvedContainerClass = "flex-row items-center px-2.5 py-1 rounded-full border bg-orange-50 border-orange-100";
    resolvedTextClass = "text-[10px] font-bold text-orange-700";
    resolvedIconName = "restaurant";
    resolvedIconColor = "#C2410C";
    resolvedLabel = label || "Preparing";
  } else if (s === "completed" || s === "complete") {
    resolvedContainerClass = "flex-row items-center px-2.5 py-1 rounded-full border bg-green-50 border-green-100";
    ...
    resolvedContainerClass = "flex-row items-center px-2.5 py-1 rounded-full border bg-pink-50 border-pink-100";
    ...
    resolvedContainerClass = "flex-row items-center px-2.5 py-1 rounded-full border bg-neutral/5 border-neutral/10";
