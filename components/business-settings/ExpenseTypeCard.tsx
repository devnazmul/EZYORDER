  ...
  return (
    <View className="bg-base-300 border border-base-200 rounded-xl p-4 shadow-sm mb-4">
      ...
      <View className="flex-row items-start justify-between gap-3 mb-2">
        <Text className="text-md font-bold text-neutral flex-1">{expenseType.name}</Text>
      ...
      {expenseType.description ? (
        ...
        <Text className="text-xs font-semibold text-accent/50 italic mt-1">No description provided</Text>
      )}
    </View>
  );
}
